...
import { useBestSellers } from '../../hooks/product/useBestSellers';
            ...
            {products.map((product, index) => {
              ...
              return (
                <div
                  ...
                  className="group min-w-[280px] bg-white dark:bg-gray-700 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 flex flex-col overflow-hidden relative"
                >
                  {/* Rank Badge */}
                  <div className="absolute top-3 left-3 z-10 w-12 h-12 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-full flex items-center justify-center shadow-lg">
                    <span className="text-white font-bold text-lg">#{rank}</span>
                  </div>

                  {/* Best Seller Badge */}
                  <div className="absolute top-3 left-16 z-10 px-3 py-1 bg-gradient-to-r from-orange-500 to-red-500 text-white text-xs font-bold rounded-full shadow-md">
                    BEST SELLER
                  </div>
                  ...
                  >
                    ...
                    {displayData.discountPercent > 0 && (
                      <div className="absolute bottom-3 left-3 px-3 py-1 bg-red-500 text-white text-sm font-bold rounded-full">
                        ...
                        <div className="flex items-center">
                          ...
                          {displayData.ratingStars.hasHalf && (
                            <svg className="w-4 h-4 text-yellow-400" viewBox="0 0 20 20">
                              <defs>
                                <linearGradient id={`half-star-${rank}`}>
                                  <stop offset="50%" stopColor="currentColor" />
                                  <stop offset="50%" stopColor="transparent" />
                                </linearGradient>
                              </defs>
                              <path fill={`url(#half-star-${rank})`} d="M10 15l-5.878 3.09 1.123-6.545L.489 6.91l6.572-.955L10 0l2.939 5.955 6.572.955-4.756 4.635 1.123 6.545z" />
                            </svg>
                          )}
